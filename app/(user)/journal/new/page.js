...
export default function NewJournalPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <h1 className="text-2xl font-bold text-gray-100 mb-6">New Trade Entry</h1>

      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-xl p-6 space-y-4">
          <h2 className="font-semibold text-gray-100 text-sm uppercase tracking-wider text-amber-400">Trade Details</h2>
          ...
          <div className="grid grid-cols-2 gap-4">
            <InputField label="Entry Price" name="entryPrice" type="number" step="any" required value={form.entryPrice} onChange={handleChange} placeholder="0.00" />
            <InputField label="Exit Price" name="exitPrice" type="number" step="any" required value={form.exitPrice} onChange={handleChange} placeholder="0.00" />
            <InputField label="Stop Loss" name="stopLoss" type="number" step="any" required value={form.stopLoss} onChange={handleChange} placeholder="0.00" />
            <InputField label="Take Profit" name="takeProfit" type="number" step="any" required value={form.takeProfit} onChange={handleChange} placeholder="0.00" />
          </div>
        ...
        <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-xl p-6 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              rows={4}
              placeholder="Write your trade analysis, observations..."
        ...
        <div className="flex gap-3">
          <Link
            href="/journal"
            className="px-6 py-2.5 border border-[#2a2a2a] text-gray-400 hover:text-gray-100 rounded-lg text-sm transition-colors"
          >
            Cancel
          </Link>
          <button
